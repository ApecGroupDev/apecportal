export default function HomePage() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-6 bg-customBlue text-white">
      ...
      <a
        href="/qr"
        className="mt-6 text-white bg-red-600 px-6 py-2 rounded-md font-bold"
      >
        Generate QR Codes
      </a>
    </main>
